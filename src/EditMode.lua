...
local function CanShowEditor()
  return modeActive and selectionsShown and available and not ns.Config.IsReadOnly() and ns.Game.CanConfigure()
end
...
function EditMode.TryAttachOverlayToggle()
  ...
  if not library or minor ~= OVERLAY_MINOR or type(library.RegisterCallback) ~= "function" or type(library.AddFrame) ~= "function" then
