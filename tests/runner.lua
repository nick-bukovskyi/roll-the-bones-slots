...
dofile("tests/eligibility_spec.lua")(test, harness, loadAddon)
dofile("tests/slash_spec.lua")(test, harness, loadAddon)
dofile("tests/settings_spec.lua")(test, harness, loadAddon)
dofile("tests/compact_mode_spec.lua")(test, harness, loadAddon)
dofile("tests/appearance_spec.lua")(test, harness, loadAddon)
